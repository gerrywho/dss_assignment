...
import com.conygre.training.services.CompactDiscServiceEJB;
...
public class CompactDiscRestService {
	@EJB
	private CompactDiscService cdEJB;
...
//    
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public List<CompactDisc> listAllCDs() {
    	//CompactDisc[] cdArray = new CompactDisc[0];
        return cdEJB.getCatalog();
    }
